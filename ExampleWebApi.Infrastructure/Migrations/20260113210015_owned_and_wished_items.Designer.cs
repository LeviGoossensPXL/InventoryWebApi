...
namespace ExampleWebApi.Infrastructure.Migrations
{
    ...
    [Migration("20260113210015_owned_and_wished_items")]
    partial class owned_and_wished_items
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupOwnedItem", b =>
                {
                    b.Property<int>("GroupsId")
                        .HasColumnType("integer");

                    b.Property<int>("OwnedItemsId")
                        .HasColumnType("integer");

                    b.HasKey("GroupsId", "OwnedItemsId");

                    b.HasIndex("OwnedItemsId");

                    b.ToTable("GroupOwnedItem");
                });
            ...
            modelBuilder.Entity("GroupWishedItem", b =>
                {
                    b.Property<int>("GroupsId")
                        .HasColumnType("integer");

                    b.Property<int>("WishedItemsId")
                        .HasColumnType("integer");

                    b.HasKey("GroupsId", "WishedItemsId");

                    b.HasIndex("WishedItemsId");

                    b.ToTable("GroupWishedItem");
                });
            ...
            modelBuilder.Entity("GroupOwnedItem", b =>
                {
                    ...
                    b.HasOne("ExampleWebApi.Domain.Entities.OwnedItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GroupProject", b =>
                {
                    ...
                    b.HasOne("ExampleWebApi.Domain.Entities.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GroupWishedItem", b =>
                {
                    ...
                    b.HasOne("ExampleWebApi.Domain.Entities.WishedItem", null)
                        .WithMany()
                        .HasForeignKey("WishedItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
